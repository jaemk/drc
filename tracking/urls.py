...
urlpatterns = [
    ...
    url(r'^subscriptions/$', views.subscribed_drawings, name='subscriptions'),
    url(r'^subscribe/drawing/toggle/(?P<drawing_name>[a-zA-Z0-9_-]+)/next/(?P<go_to>(drawing|list))/$',
        views.subscribe_drawing, name='subscribe_drawing'),
